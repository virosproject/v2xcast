...
typedef struct ConnectionManeuverAssist_addGrpC_V2 ConnectionManeuverAssist_addGrpC_V2;
...
typedef struct LaneAttributes_addGrpC LaneAttributes_addGrpC;
typedef struct MapData_addGrpC MapData_addGrpC;
typedef struct MovementEvent_addGrpC MovementEvent_addGrpC;
typedef struct NodeAttributeSet_addGrpC NodeAttributeSet_addGrpC;
...
typedef struct RestrictionUserType_addGrpC_V2 RestrictionUserType_addGrpC_V2;
typedef struct RequestorDescription_addGrpC RequestorDescription_addGrpC;
typedef struct SignalStatusPackage_addGrpC SignalStatusPackage_addGrpC;
typedef struct SignalStatusPackage_addGrpC_V2 SignalStatusPackage_addGrpC_V2;
...
typedef struct TimeChangeDetails {
    ...
    int32_t startTime; /* TimeMark (0..36111) */
    int32_t minEndTime; /* TimeMark (0..36111) */
    BOOL maxEndTime_option;
    int32_t maxEndTime; /* TimeMark (0..36111) */
    BOOL likelyTime_option;
    int32_t likelyTime; /* TimeMark (0..36111) */
    BOOL confidence_option;
    int32_t confidence; /* TimeIntervalConfidence (0..15) */
    BOOL nextTime_option;
    int32_t nextTime; /* TimeMark (0..36111) */
} TimeChangeDetails;
...
typedef struct Reg_SignalStatusPackage {
    ...
    uintptr_t *asn1Type; /* Don't modify it. It is for internal processing. */
    union {
        SignalStatusPackage_addGrpC_V2 *grpc;
        void *data;
        OctetString unknown;
    } u;
...
typedef struct TravelerDataFrame {
    ...
    int32_t durationTime; /* MinutesDuration (0..32000) */
    int32_t priority; /* SignPrority (0..7) */
    int32_t notUsed1; /* SSPindex (0..31) */
    GeographicalPathList regions;
    int32_t notUsed2; /* SSPindex (0..31) */
    int32_t notUsed3; /* SSPindex (0..31) */
    TDFcontent content;
    BOOL url_option;
...
typedef struct ItsStationPosition {
  ...
  int32_t timeReference; /* TimeReference (0..60000) */
} ItsStationPosition;
...
typedef struct LaneAttributes_addGrpC {
  ...
  int32_t maxVehicleWeight; /* VehicleMass_addGrpC (1..1024) */
...
typedef enum ExceptionalCondition {
  ...
  ExceptionalCondition_MAX = UINT_MAX
...
enum {
  VehicleMass_addGrpC_hundredKg = 1,
  VehicleMass_addGrpC_unavailable = 1024,
};
