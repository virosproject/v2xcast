...
enum { /* Pre-defined values of CauseCodeType */
       ...
       CauseCodeType_impassability_V2 = 5,
       CauseCodeType_adverseWeatherCondition_Adhesion = 6,
       CauseCodeType_aquaplannning_V2 = 7,
...
enum { /* Pre-defined values of VehicleBreakdownSubCauseCode */
       ...
       VehicleBreakdownSubCauseCode_tyrePressureProblem_V2 = 9,
};
...
enum { /* Pre-defined values of CurvatureValue_V2 */
       CurvatureValue_straight_V2 = 0,
       CurvatureValue_unavailable_V2 = 1023,
};
...
typedef struct Curvature {
    int32_t curvatureValue; /* CurvatureValue (-30000..30001), CurvatureValue_V2 (-1023..1023) */
...
#define DrivingLaneStatus_MAX_BITS_V2 13
...
typedef struct ClosedLanes_V2 {
    BOOL innerhardShoulderStatus_option;
    HardShoulderStatus innerhardShoulderStatus;
    BOOL outerhardShoulderStatus_option;
    HardShoulderStatus outerhardShoulderStatus;
    BOOL drivingLaneStatus_option;
    BitString drivingLaneStatus; /* DrivingLaneStatus_MAX_BITS_V2 (1..13) */
} ClosedLanes_V2;
...
typedef struct DangerousGoodsExtended {
    ...
    OctetString phoneNumber; /* PhoneNumber (1..16) */
...
typedef enum ProtectedZoneType {
    ...
    ProtectedZoneType_temporaryCenDsrcTolling_V2,
...
#define DigitalMap_MAX_SIZE 256
