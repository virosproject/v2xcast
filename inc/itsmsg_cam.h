...
typedef struct RoadWorksContainerBasic_V2 {
    BOOL roadworksSubCauseCode_option;
    int32_t roadworksSubCauseCode; /* RoadworksSubCauseCode (0..255) */
    BitString lightBarSirenInUse; /* LightBarSirenInUse (2..2) */
    BOOL closedLanes_option;
    ClosedLanes_V2 closedLanes;
} RoadWorksContainerBasic_V2;

typedef struct SpecialVehicleContainer_V2 {
    SpecialVehicleContainer_choice choice;
    union {
        PublicTransportContainer publicTransportContainer;
        SpecialTransportContainer specialTransportContainer;
        DangerousGoodsContainer dangerousGoodsContainer;
        RoadWorksContainerBasic_V2 roadWorksContainerBasic;
        RescueContainer rescueContainer;
        EmergencyContainer emergencyContainer;
        SafetyCarContainer safetyCarContainer;
    } u;
} SpecialVehicleContainer_V2;

typedef struct CamParameters_V2 {
    BasicContainer basicContainer;
    HighFrequencyContainer highFrequencyContainer;
    BOOL lowFrequencyContainer_option;
    LowFrequencyContainer lowFrequencyContainer;
    BOOL specialVehicleContainer_option;
    SpecialVehicleContainer_V2 specialVehicleContainer;
} CamParameters_V2;


typedef struct CoopAwareness_V2 {
    int32_t generationDeltaTime; /* GenerationDeltaTime (0..65535) */
    CamParameters_V2 camParameters;
} CoopAwareness_V2;

typedef struct CAM_V2 {
    ItsPduHeader header;
    CoopAwareness_V2 cam;
} CAM_V2;
#ifdef __cplusplus
}
#endif
